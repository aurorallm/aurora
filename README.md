...
<p align="center">Route AI traffic through a single OpenAI-compatible and Anthropic-compatible API.<br>Self-hosted AI gateway with no vendor lock-in. Supports 30+ LLM providers including OpenAI, Anthropic Claude, Google Gemini, Groq, and DeepSeek.<br><a href="https://raw.githubusercontent.com/aurorallm/aurora/main/docs/assets/comparison.png">Enterprise edition</a> available with SSO, RBAC, tenant isolation, and production support.</p>
