...
const DashboardSettingsSnapshotSchema = z
  .object({
    ...
    observability: z
      ...
      .optional()
      .default({}),
    observability_exports: z
      .object({
        enabled: z.boolean().optional().default(false),
        destination: z.string().optional().default("otlp"),
        endpoint: z.string().optional().default(""),
        format: z.string().optional().default("json"),
        auth_mode: z.string().optional().default("none"),
        sample_rate: z.number().optional().default(1),
        redact_headers: z.boolean().optional().default(true),
        labels: z.record(z.string()).optional().default({}),
        status: z.string().optional().default("disabled"),
        last_error: z.string().optional().default(""),
        last_success: z.string().optional().default(""),
      })
      .optional()
      .default({}),
    cluster: z
      .object({
        enabled: z.boolean().optional().default(false),
        node_id: z.string().optional().default("local"),
        node_name: z.string().optional().default("local"),
        region: z.string().optional().default(""),
        zone: z.string().optional().default(""),
        advertise_url: z.string().optional().default(""),
        heartbeat_interval_seconds: z.number().int().optional().default(30),
        failover_mode: z.string().optional().default("single_node"),
        status: z.string().optional().default("single-node"),
        node_count: z.number().int().optional().default(1),
      })
      .optional()
      .default({}),
    compliance: z
      .object({
        enabled: z.boolean().optional().default(false),
        audit_immutability: z.boolean().optional().default(false),
        data_residency: z.string().optional().default("unspecified"),
        pii_logging_policy: z.string().optional().default("redact"),
        evidence_retention_days: z.number().int().optional().default(365),
        access_review_cadence_days: z.number().int().optional().default(90),
        evidence_export_target: z.string().optional().default(""),
        status: z.string().optional().default("disabled"),
      })
      .optional()
      .default({}),
