...
type dashboardObservabilityExportsOverlay struct {
	Enabled       *bool             `yaml:"enabled,omitempty"`
	...
	RedactHeaders *bool             `yaml:"redact_headers,omitempty"`
	Labels        map[string]string `yaml:"labels,omitempty"`
}

type dashboardClusterOverlay struct {
	Enabled           *bool   `yaml:"enabled,omitempty"`
...
type dashboardComplianceOverlay struct {
	Enabled                 *bool   `yaml:"enabled,omitempty"`
	AuditImmutability       *bool   `yaml:"audit_immutability,omitempty"`
	DataResidency           *string `yaml:"data_residency,omitempty"`
	PIILoggingPolicy        *string `yaml:"pii_logging_policy,omitempty"`
	EvidenceRetentionDays   *int    `yaml:"evidence_retention_days,omitempty"`
	AccessReviewCadenceDays *int    `yaml:"access_review_cadence_days,omitempty"`
	EvidenceExportTarget    *string `yaml:"evidence_export_target,omitempty"`
}
